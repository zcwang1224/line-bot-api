...
from models.exhibit import ExhibitCreateModel
...
async def create(
    ...
    try:
        data = ExhibitCreateModel.model_validate_json(body.decode(encoding='utf-8'))
    ...
    try:
        db_main_session.add(new_exhibit)
