...
class Event(Base, BaseUtil):
    ...
    events_id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    ev_name = Column(String(100), nullable=False, comment="活動名稱")
    ...
    accu_url = Column(Text, comment="ACCUPASS 連結")  
    ...
    def __repr__(self):
        return "<%s(id=%s, name=%s)>" % (self.__class__.__name__, self.events_id, self.ev_name)
