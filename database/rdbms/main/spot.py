...
class Spot(Base, BaseUtil):
    ...
    spot_id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    s_name = Column(String(100), nullable=False, comment="景點名")
    ...
    s_type = Column(String(3), comment="類型")
    ...
    def __repr__(self):
        return "<%s(id=%s, name=%s)>" % (self.__class__.__name__, self.spot_id, self.s_name)
